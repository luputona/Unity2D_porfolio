    ...
    public void ConstructData()
    {
        for (int i = 0; i < m_spearJsonData.Count; i++)
        {
            m_spearItemList.Add(new SwordItem(
                ...
                m_spearJsonData[i]["discription"].ToString(),
                m_spearJsonData[i]["skill_name"].ToString(),
                m_spearJsonData[i]["skill_Dis"].ToString(),
...
public class SpearItem
{
    ...
    public SpearItem(int id, string name, string discription, string skill_name, string skill_dis,
