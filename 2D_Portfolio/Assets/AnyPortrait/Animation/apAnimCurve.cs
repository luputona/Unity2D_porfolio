...
namespace AnyPortrait
{
	...
	public class apAnimCurve
	{
		...
		public float GetItp_Float(float curKeyframe, bool isWithPrevKey)
		{
			if (isWithPrevKey)
			{
				return _prevCurveResult.GetInterpolation_Float(curKeyframe);
			}
			else
			{
				return _nextCurveResult.GetInterpolation_Float(curKeyframe);
			}
		}
