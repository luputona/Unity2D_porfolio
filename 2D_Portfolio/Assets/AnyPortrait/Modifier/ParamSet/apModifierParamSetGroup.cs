...
namespace AnyPortrait
{
	...
	public class apModifierParamSetGroup
	{
		...
		[NonSerialized]
		public bool _isEnabledExclusive = true;
		...
		[NonSerialized]
		public List<Vector2> _tmpPositions = new List<Vector2>();
