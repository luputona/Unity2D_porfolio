...
namespace AnyPortrait
{
	...
	public class apBone
	{
		...
		///// <summary>
		///// World Matrix의 Inverse (RMultipy로 완성된 Matrix는 별도의 Inverse를 두어야 한다.)
		///// </summary>
		//[NonSerialized]
		//public apMatrix _invWorldMatrix = new apMatrix();

		///// <summary>
		///// World Matrix (Non Modified)의 Inverse
		///// </summary>
		//[NonSerialized]
		//public apMatrix _invWorldMatrix_NonModified = new apMatrix();
