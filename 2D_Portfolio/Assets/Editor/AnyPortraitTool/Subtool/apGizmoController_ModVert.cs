...
namespace AnyPortrait
{
	...
	public partial class apGizmoController
	{
		...
		public void Move__Modifier_VertexPos(Vector2 curMouseGL, Vector2 curMousePosW, Vector2 deltaMoveW, int btnIndex, bool isFirstMove)
		{
			...
			apEditorUtil.SetRecord(apUndoGroupData.ACTION.Modifier_Gizmo_MoveVertex, Editor.Select.Modifier._meshGroup, targetVert, isMultipleVerts, Editor);
		...
		public void Rotate__Modifier_VertexPos(float deltaAngleW)
		{
			if (Editor.Select.MeshGroup == null || Editor.Select.Modifier == null)
			{
				return;
			...
			apEditorUtil.SetRecord(apUndoGroupData.ACTION.Modifier_Gizmo_RotateVertex, Editor.Select.Modifier._meshGroup, targetVert, isMultipleVerts, Editor);
		...
		public void Scale__Modifier_VertexPos(Vector2 deltaScaleW)
		{
			...
			apEditorUtil.SetRecord(apUndoGroupData.ACTION.Modifier_Gizmo_ScaleVertex, Editor.Select.Modifier._meshGroup, targetVert, isMultipleVerts, Editor);
		...
		public void TransformChanged_Color__Modifier_Vertex(Color color, bool isVisible)
		{
			...
			//Undo
			apEditorUtil.SetRecord(apUndoGroupData.ACTION.Modifier_Gizmo_Color, Editor.Select.Modifier._meshGroup, Editor.Select.ExKey_ModMesh, false, Editor);
		...
		public apGizmos.TransformParam PivotReturn__Modifier_Vertex()
		{
			...
			if (Editor.Select.ModRenderVertOfMod == null)
			{
				...
				{
					return apGizmos.TransformParam.Make(Vector2.zero, 0.0f, Vector2.one, 0,
		...
		public bool FFDTransform__Modifier_VertexPos(List<object> srcObjects, List<Vector2> posWorlds, bool isResultAssign)
		{
			...
			//Undo
			apEditorUtil.SetRecord(apUndoGroupData.ACTION.Modifier_Gizmo_FFDVertex, Editor.Select.Modifier._meshGroup, null, true, Editor);
		...
		public bool PressBlur__Modifier_VertexPos(Vector2 pos, float tDelta)
		{
			if (Editor.Select.ExKey_ModMesh._transform_Mesh == null
				|| Editor.Select.ExKey_ModMesh._vertices == null
