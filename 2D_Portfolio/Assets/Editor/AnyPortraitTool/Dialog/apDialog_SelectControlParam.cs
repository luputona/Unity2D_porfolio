...
namespace AnyPortrait
{
	...
	public class apDialog_SelectControlParam : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			GUILayout.Space(10);
			GUILayout.Button("Select Control Param", guiStyle_Center, GUILayout.Width(width), GUILayout.Height(15));//<투명 버튼
			GUILayout.Space(10);
			...
			GUILayout.Button(new GUIContent("Control Parameters", iconImageCategory), guiStyle, GUILayout.Height(20));//<투명 버튼
