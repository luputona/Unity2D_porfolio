...
namespace AnyPortrait
{
	...
	public class apDialog_AddModifier : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			GUILayout.Space(10);
			GUILayout.Button("Select Modifier", guiStyle_Center, GUILayout.Width(width), GUILayout.Height(15));//<투명 버튼
			GUILayout.Space(10);
			...
			GUILayout.Button(new GUIContent("Modifiers", iconImageCategory), guiStyle, GUILayout.Height(20));//<투명 버튼
